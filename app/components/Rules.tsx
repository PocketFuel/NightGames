  ...
  return (
    <section className="w-full flex flex-col gap-3 max-w-3xl pb-6 mx-auto">
      ...
      <ol className="flex flex-col gap-3 ml-5">
        ...
        <li className="text-day/50 text-md md:text-lg">Numbers are always subject to change. We'd like the winners to feel they actually won something and our community has demanded that a portion of every pot go toward token burns.</li>
      </ol>
    </section>
  );
};
